                ...
                <header className="flex h-20 items-center justify-between px-6">
                    <div className="">
                        <div className="flex flex-col items-center">
                            ...
                            <p className="font-bold text-[10px]">Baby Garden</p>
                        </div>
                    </div>
                    <div className="shadow-[#C6E0EA] flex items-center justify-center md:max-w-[70%] max-w-[50%] w-full rounded-full shadow flex-wrap h-[60px] px-5">
                        {/* <div > */}
                    ...
                    <Dropdown>
                        ...
                        <Dropdown.Popover>
                            <Dropdown.Menu onAction={(key) => console.log(`Selected: ${key}`)}>
                                {/* <ul className="flex flex-wrap items-center gap-5"> */}
                                    <Dropdown.Item>
                                        <Link href="/" className={` w-full rounded-2xl ${path === '/' ? "border-2 border-[#C6E0EA]" : ""} px-3 py-2 transition-all`}>
                                            <i className="fad fa-home mr-1"></i>
                                            Home
                                        </Link>
                                    </Dropdown.Item>
                                    <Dropdown.Item>
                                        <Link href="/about" className={` w-full rounded-2xl ${path === '/about' ? "border-2 border-[#C6E0EA]" : ""} px-3 py-2 transition-all`}>
                                            <i className="fad fa-circle-info mr-1"></i>
                                            About
                                        </Link>
                                    </Dropdown.Item>
                                    <Dropdown.Item>
                                        <Link href={"/contact"} className={` w-full rounded-2xl ${path === '/contact' ? "border-2 border-[#C6E0EA]" : ""} px-3 py-2 transition-all`}>
                                            <i className="fa-duotone fa-thin fa-address-book mr-1"></i>
                                            Contact
                                        </Link>
                                    </Dropdown.Item>
                                    <Dropdown.Item>
                                        <Link href={"/babies"} className={`hover:bg-[#fbd583bc]  w-full rounded-2xl ${path === '/babies' ? "border-2 border-[#C6E0EA]" : ""} px-3 py-2 transition-all`}>
                                            <i className="fad fa-baby mr-1"></i>
                                            Babies
                                        </Link>
                                    </Dropdown.Item>
                                    <Dropdown.Item>
                                        <Link href={"/addBaby"} className={` w-full rounded-2xl ${path === '/registration' ? "border-2 border-[#C6E0EA]" : ""} px-3 py-2 transition-all`}>
                                            <i className="fad fa-baby mr-1"></i>
                                            Registration
                                        </Link>
                                    </Dropdown.Item>
